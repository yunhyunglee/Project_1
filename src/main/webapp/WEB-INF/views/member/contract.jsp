...
<section class="terms-container">
	<article>
		<form method="get" name="contract" class="terms-form">
			<!-- 약관 제목 -->
			<h2 class="terms-title">회원 가입 약관</h2>

			<!-- 약관 내용 -->
			<p class="terms-intro">
				아래 약관을 읽고 동의 여부를 선택하세요.
			</p>

			<div class="terms-content">
                <textarea rows="10" readonly>제 1 장 총칙
제 1 조 (목적)
본 약관은 (주)제이피 이노베이션(이하 “회사”라 합니다)이 운영하는 웹사이트 ‘어반런드렛’ (http://localhost:8070/) (이하 “웹사이트”라 합니다)에서 제공하는 온라인 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버몰과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
...
본 약관은 2020년 05월 1일부터 적용한다.
			...
			<div class="radio-group">
				<!-- 동의/동의안함 -->
				<div class="option agree-disagree">
					<input type="radio" id="agree" name="okon" />
					<label for="agree">동의함</label>

					<input type="radio" id="disagree" name="okon" checked />
					<label for="disagree">동의하지 않음</label>
				</div>

				<!-- 개인회원/사업자회원 -->
				<div class="option member-type">
					<input type="radio" id="personal" name="membertype" />
					<label for="personal">일반회원</label>

					<input type="radio" id="business" name="membertype" />
			...
			<div class="button-group">
				<button type="button" onclick="goNext()" class="btn next-btn">Next</button>
			</div>
		</form>
	</article>
</section>
